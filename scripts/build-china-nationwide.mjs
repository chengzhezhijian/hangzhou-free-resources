...
function stableId(city, category, name) {
  const prefix = { library: "lib", reading: "read", museum: "mus", park: "park", tool: "tool", station: "sta", toilet: "toil", parking: "pkg", sports: "sport", community: "com", charging: "chg", bunker: "bnkr", policy: "pol", camping: "camp", legal: "legal", training: "train" }[category] || "res";
  let h = 0;
